...
const renderElementGenre = (genres) => {
  if (genres.length > 0) {
    ...
    {boxes.push(`<span class="film-details__genre">${element}</span>`);}
    return boxes;
  }
};
export const createControlTemplate = (data) => (`<section class="film-details__controls">
<button type="button" class="film-details__control-button ${addClass(data.user_details.watchlist, 'film-details__control-button--active')} film-details__control-button--watchlist" id="watchlist" name="watchlist">Add to watchlist</button>
<button type="button" class="film-details__control-button ${addClass(data.user_details.already_watched, 'film-details__control-button--active')} film-details__control-button--watched" id="watched" name="watched">Already watched</button>
<button type="button" class="film-details__control-button ${addClass(data.user_details.favorite, 'film-details__control-button--active')} film-details__control-button--favorite" id="favorite" name="favorite">Add to favorites</button>
</section>`);
        ...
        <div class="film-details__info-wrap">
          ...
          <div class="film-details__info">
            ...
            <table class="film-details__table">
              ...
              ${renderFilmDetailsTable(thoWordChange(genre, 'Genre'), renderElementGenre(genre).join(' '))}
            </table>
